...
const translationEntries: TranslationEntry[] = [
  ...
  { en: 'Projections', tr: 'Projeksiyonlar' },
  ...
  { en: 'KPIs', tr: 'KPI\'lar' },
  { en: 'Result', tr: 'Sonuç' },
  { en: 'Projection', tr: 'Projeksiyon' },
  { en: 'Add Result', tr: 'Sonuç Ekle' },
  { en: 'Add Projection', tr: 'Projeksiyon Ekle' },
  { en: 'Result Type', tr: 'Sonuç Türü' },
  { en: 'Result Value', tr: 'Sonuç Değeri' },
  { en: 'Current Year', tr: 'Cari Yıl' },
  { en: 'Previous Forecast', tr: 'Önceki Tahmin' },
  { en: 'Actual Result', tr: 'Gerçekleşen Sonuç' },
  { en: 'Variance', tr: 'Sapma' },
  { en: 'Projection Comparison', tr: 'Projeksiyon Karşılaştırması' },
  {
    en: 'Compare actual KPI results against prior-year projections across the latest 5 or 10 periods.',
    tr: 'KPI gerçekleşen sonuçlarını son 5 veya 10 dönem için önceki yıl projeksiyonlarıyla karşılaştırın.',
  },
  { en: 'Projection data is loading...', tr: 'Projeksiyon verileri yükleniyor...' },
  { en: 'Tracked KPIs', tr: 'Takip Edilen KPI\'lar' },
  { en: 'items', tr: 'öğe' },
  { en: 'Last 5', tr: 'Son 5' },
  { en: 'Last 10', tr: 'Son 10' },
  { en: 'periods', tr: 'dönem' },
  {
    en: 'No KPI projection history is available yet.',
    tr: 'Henüz KPI projeksiyon geçmişi bulunmuyor.',
  },
  { en: 'Tracked Periods', tr: 'Takip Edilen Dönemler' },
  { en: 'Actual Results', tr: 'Gerçekleşen Sonuçlar' },
  { en: 'Forecast Comparisons', tr: 'Tahmin Karşılaştırmaları' },
  {
    en: 'Each row shows the actual result for that academic year, the prior year forecast for the same period, and the stored 6-box projection set.',
    tr: 'Her satır o akademik yılın gerçek sonucunu, aynı dönem için bir önceki yıl tahminini ve kaydedilmiş 6 kutuluk projeksiyon setini gösterir.',
  },
  {
    en: 'Select a KPI with projection history to view comparisons.',
    tr: 'Karşılaştırmaları görmek için projeksiyon geçmişi olan bir KPI seçin.',
  },
  { en: 'No result', tr: 'Sonuç yok' },
  { en: 'No projection', tr: 'Projeksiyon yok' },
  { en: 'Current year empty', tr: 'Cari yıl boş' },
  { en: 'filled', tr: 'dolu' },
  { en: 'Enter the KPI result', tr: 'KPI sonucunu girin' },
  { en: 'Failed to save KPI result', tr: 'KPI sonucu kaydedilemedi' },
  { en: 'Failed to save KPI projections', tr: 'KPI projeksiyonları kaydedilemedi' },
  ...
  { en: 'Copy From Previous Year', tr: 'Önceki Yıldan Kopyala' },
  {
    en: 'Choose goals from the previous year and copy them here as unassigned items.',
    tr: 'Önceki yıldaki hedefleri seçin ve onları buraya atanmamış öğeler olarak kopyalayın.',
  },
  { en: 'Load Previous Year Items', tr: 'Önceki Yıl Öğelerini Yükle' },
  { en: 'Previous Year Items', tr: 'Önceki Yıl Öğeleri' },
  {
    en: 'Select the items you want to carry into the new year.',
    tr: 'Yeni yıla taşımak istediğiniz öğeleri seçin.',
  },
  { en: 'Load Selected Items', tr: 'Seçili Öğeleri Yükle' },
  { en: 'Copy Selected Items', tr: 'Seçili Öğeleri Kopyala' },
  { en: 'Items Selected', tr: 'Öğe Seçildi' },
  { en: 'Select at least one goal to copy.', tr: 'Kopyalamak için en az bir hedef seçin.' },
  {
    en: 'No main goals were found for this source year.',
    tr: 'Bu kaynak yıl için ana hedef bulunamadı.',
  },
  { en: 'Copied successfully', tr: 'Başarıyla kopyalandı' },
  {
    en: 'Loaded into current year as unassigned items',
    tr: 'Yeni yıla atanmamış öğeler olarak yüklendi',
  },
  ...
  { en: 'Assignments and ownership will be cleared', tr: 'Atamalar ve sahiplik temizlenecek' },
  ...
  {
    en: 'Use these owners as a reference when assigning copied work manually.',
    tr: 'Kopyalanan işleri manuel atarken bu sorumluları referans olarak kullanın.',
  },
  {
    en: 'Copied goals stay here until an admin assigns them manually.',
    tr: 'Kopyalanan hedefler bir yönetici manuel atama yapana kadar burada kalır.',
  },
  { en: 'Unassigned Goals', tr: 'Atanmamış Hedefler' },
  { en: 'Unassigned', tr: 'Atanmamış' },
  { en: 'Hide Children', tr: 'Alt Öğeleri Gizle' },
  { en: 'Show Children', tr: 'Alt Öğeleri Göster' },
  { en: 'Assign Selected Goals', tr: 'Seçili Hedefleri Ata' },
  {
    en: 'Select one or more copied items and assign the whole tree to one person.',
    tr: 'Bir veya daha fazla kopyalanmış öğe seçin ve tüm ağacı tek bir kişiye atayın.',
  },
  { en: 'Assign Selected', tr: 'Seçilileri Ata' },
  { en: 'Assign This Goal', tr: 'Bu Hedefi Ata' },
  { en: 'Assign', tr: 'Ata' },
  { en: 'Assigned directly', tr: 'Doğrudan atandı' },
  { en: 'Refresh', tr: 'Yenile' },
  { en: 'Assigned person is required.', tr: 'Atanacak kişi zorunludur.' },
  { en: 'Select one or more goals first.', tr: 'Önce bir veya daha fazla hedef seçin.' },
  { en: 'Assignment summary', tr: 'Atama özeti' },
  { en: 'Loading goals...', tr: 'Hedefler yükleniyor...' },
  {
    en: 'No unassigned goals exist for this year yet.',
    tr: 'Bu yıl için henüz atanmamış hedef yok.',
  },
  {
    en: 'Future years stay empty until you copy items into them here.',
    tr: 'Gelecek yıllar, buradan öğe kopyalayana kadar boş kalır.',
  },
  ...
  { en: 'Select KPI', tr: 'KPI Seç' },
  { en: 'No KPIs with projection data found.', tr: 'Projeksiyon verisi girilmiş KPI bulunamadı.' },
  { en: 'Total Forecast Years', tr: 'Toplam Tahmin Yılı' },
  { en: 'Rows Shown', tr: 'Gösterilen Satır' },
  { en: 'older forecast years hidden', tr: 'eski tahmin yılı gizlendi' },
  { en: 'Forecast Source', tr: 'Tahmin Kaynağı' },
  { en: 'Add projections for a KPI from Goal Hierarchy to see it here.', tr: 'Görünmesi için Hedef Hiyerarşisi\'nden bir KPI için projeksiyon ekleyin.' },

  // — Audit Log page —
  { en: 'Audit Log', tr: 'Denetim Günlüğü' },
  { en: 'Submission history for all KPIs and Action Plans', tr: 'Tüm KPI\'lar ve Aksiyon Planları için gönderim geçmişi' },
  { en: 'Search by title or user...', tr: 'Başlık veya kullanıcıya göre ara...' },
  { en: 'Entity Type', tr: 'Varlık Türü' },
  { en: 'All Types', tr: 'Tüm Türler' },
  { en: 'KPIs Only', tr: 'Yalnızca KPI\'lar' },
  { en: 'Action Plans Only', tr: 'Yalnızca Aksiyon Planları' },
  { en: 'All Years', tr: 'Tüm Yıllar' },
  { en: 'entries', tr: 'kayıt' },
  { en: 'Loading...', tr: 'Yükleniyor...' },
  { en: 'No log entries found.', tr: 'Kayıt bulunamadı.' },
  { en: 'Entity', tr: 'Varlık' },
  { en: 'Submitted By', tr: 'Gönderen' },
  { en: 'Cycle Deadline', tr: 'Dönem Son Tarihi' },
  { en: 'Logged At', tr: 'Kayıt Tarihi' },
  { en: 'Details', tr: 'Detaylar' },
  { en: 'via', tr: 'aracılığıyla' },
  { en: 'Type', tr: 'Tür' },
  { en: 'Value', tr: 'Değer' },
  { en: 'Entered By', tr: 'Giren' },
  { en: 'Entered At', tr: 'Giriş Tarihi' },
  { en: 'No result was entered for this cycle.', tr: 'Bu dönem için sonuç girilmedi.' },
  { en: 'No projections were entered for this cycle.', tr: 'Bu dönem için projeksiyon girilmedi.' },
  { en: 'You do not have permission to view this page.', tr: 'Bu sayfayı görüntüleme izniniz yok.' },

  // — User Management page —
  { en: 'User Management', tr: 'Kullanıcı Yönetimi' },
  { en: 'Manage who can access this application via SSO', tr: 'SSO ile bu uygulamaya kimin erişebileceğini yönetin' },
  { en: 'Add User', tr: 'Kullanıcı Ekle' },
  { en: 'Search by name or email...', tr: 'Ad veya e-postaya göre ara...' },
  { en: 'No users match your search.', tr: 'Aramanıza uyan kullanıcı bulunamadı.' },
  { en: 'No authorized users yet. Add one to get started.', tr: 'Henüz yetkili kullanıcı yok. Başlamak için bir tane ekleyin.' },
  { en: 'Full Name', tr: 'Ad Soyad' },
  { en: 'Email', tr: 'E-posta' },
  { en: 'Role', tr: 'Rol' },
  { en: 'Added', tr: 'Eklenme Tarihi' },
  { en: 'Edit User', tr: 'Kullanıcı Düzenle' },
  { en: 'Add New User', tr: 'Yeni Kullanıcı Ekle' },
  { en: 'Full name is required', tr: 'Ad soyad zorunludur' },
  { en: 'Email is required', tr: 'E-posta zorunludur' },
  { en: 'e.g. Dr. Sarah Johnson', tr: 'örn. Dr. Sarah Johnson' },
  { en: 'Save Changes', tr: 'Değişiklikleri Kaydet' },
  { en: 'Remove User', tr: 'Kullanıcıyı Kaldır' },
  { en: 'Are you sure you want to remove', tr: 'Kaldırmak istediğinizden emin misiniz:' },
  { en: 'They will lose access to the application immediately.', tr: 'Uygulama erişimini hemen kaybedecekler.' },
  { en: 'Removing...', tr: 'Kaldırılıyor...' },
];
